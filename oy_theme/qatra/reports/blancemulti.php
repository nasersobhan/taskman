...
$tbl = TBL_PIX.'categories_oy';
	 ...
	 foreach ($companies as $comid => $comname) {
             ...
             $result = $dbase->query("SELECT mon_eoe,mon_mt,sum(mon_rmoney) as moneyx FROM sob_money where mon_stat=0 and mon_name='$comid' group by mon_mt,mon_eoe");
